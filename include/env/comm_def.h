...
typedef enum MsgType {
    ...
    /* DATA */
    MSG_DATA_BEGIN = MSG_BASE + 2000,
    MSG_SINGLE_POINT = MSG_DATA_BEGIN,
    MSG_SINGLE_LINESTRING = MSG_BASE + 2001,
    MSG_SINGLE_POLYGON = MSG_BASE + 2002,
    MSG_BATCH_POINT = MSG_BASE + 2003,
    MSG_BATCH_LINESTRING = MSG_BASE + 2004,
    MSG_BATCH_POLYGON = MSG_BASE + 2005,
