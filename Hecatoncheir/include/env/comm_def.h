...
typedef enum MsgType {
    ...
    MSG_PREPARE_DATASET = MSG_BATCH_BEGIN,
    ...
    MSG_QUERY_BATCH = MSG_BASE + 6003,
    MSG_QUERY_BATCH_RESULT = MSG_BASE + 6004,
    ...
    MSG_PARTITION_DATASET = MSG_BASE + 7005,
    MSG_GLOBAL_DATASPACE = MSG_BASE + 7006,
    MSG_DATASET_METADATA = MSG_BASE + 7007,
    MSG_BUILD_INDEX = MSG_BASE + 7008,
