...
import type { ComponentTokenKey, GlobalTokenWithComponent, TokenMap, TokenMapKey, UseComponentStyleResult } from '@ant-design/cssinjs-utils/lib/interface';
import type AbstractCalculator from '@ant-design/cssinjs-utils/lib/util/calc/calculator';
import type { UseCSP } from '@ant-design/cssinjs-utils/lib/hooks/useCSP';
import type { UsePrefix } from '@ant-design/cssinjs-utils/lib/hooks/usePrefix';
import type { UseToken } from '@ant-design/cssinjs-utils/lib/hooks/useToken';
...
declare function genStyleUtils<CompTokenMap extends TokenMap, AliasToken extends TokenType, DesignToken extends TokenType>(config: {
    ...
    genStyleHooks: <C extends TokenMapKey<CompTokenMap>>(component: C | [C, string], styleFn: GenStyleFn<CompTokenMap, AliasToken, C>, getDefaultToken?: GetDefaultToken<CompTokenMap, AliasToken, C>, options?: {
        resetStyle?: boolean;
        resetFont?: boolean;
        deprecatedTokens?: [keyof Exclude<import("@ant-design/cssinjs-utils/lib/interface").OverrideTokenMap<CompTokenMap, AliasToken>[C], undefined>, keyof Exclude<import("@ant-design/cssinjs-utils/lib/interface").OverrideTokenMap<CompTokenMap, AliasToken>[C], undefined>][];
        /**
         * Component tokens that do not need unit.
         */
        unitless?: Partial<Record<keyof Exclude<import("@ant-design/cssinjs-utils/lib/interface").OverrideTokenMap<CompTokenMap, AliasToken>[C], undefined>, boolean>>;
        /**
    ...
    genSubStyleComponent: <C_1 extends TokenMapKey<CompTokenMap>>(componentName: C_1 | [C_1, string], styleFn: GenStyleFn<CompTokenMap, AliasToken, C_1>, getDefaultToken?: GetDefaultToken<CompTokenMap, AliasToken, C_1>, options?: {
        resetStyle?: boolean;
        resetFont?: boolean;
        deprecatedTokens?: [keyof Exclude<import("@ant-design/cssinjs-utils/lib/interface").OverrideTokenMap<CompTokenMap, AliasToken>[C_1], undefined>, keyof Exclude<import("@ant-design/cssinjs-utils/lib/interface").OverrideTokenMap<CompTokenMap, AliasToken>[C_1], undefined>][];
        /**
         * Only use component style in client side. Ignore in SSR.
         */
        clientOnly?: boolean;
        ...
        order?: number;
        injectStyle?: boolean;
        unitless?: Partial<Record<keyof Exclude<import("@ant-design/cssinjs-utils/lib/interface").OverrideTokenMap<CompTokenMap, AliasToken>[C_1], undefined>, boolean>>;
    ...
    genComponentStyleHook: <C_2 extends TokenMapKey<CompTokenMap>>(componentName: C_2 | [C_2, string], styleFn: GenStyleFn<CompTokenMap, AliasToken, C_2>, getDefaultToken?: GetDefaultToken<CompTokenMap, AliasToken, C_2>, options?: {
        resetStyle?: boolean;
        resetFont?: boolean;
        deprecatedTokens?: [keyof Exclude<import("@ant-design/cssinjs-utils/lib/interface").OverrideTokenMap<CompTokenMap, AliasToken>[C_2], undefined>, keyof Exclude<import("@ant-design/cssinjs-utils/lib/interface").OverrideTokenMap<CompTokenMap, AliasToken>[C_2], undefined>][];
        /**
         * Only use component style in client side. Ignore in SSR.
         */
        clientOnly?: boolean;
        ...
        order?: number;
        injectStyle?: boolean;
        unitless?: Partial<Record<keyof Exclude<import("@ant-design/cssinjs-utils/lib/interface").OverrideTokenMap<CompTokenMap, AliasToken>[C_2], undefined>, boolean>>;
